...
a.p.groupingView.groupCollapse===true)ja=' style="display:none;"';for(;e<L;){p=Z[e];B=b.jgrid.getAccessor(p,s);if(B===undefined){B=$+e;if(r.length===0)if(f.cell){u=b.jgrid.getAccessor(p,f.cell);B=u!==undefined?u[s]||B:B}}B=a.p.idPrefix+B;u=j===1?0:j;u=(u+e)%2==1?U:"";H.push("<tr"+ja+' id="'+B+'" tabindex="-1" role="row" class= "ui-widget-content_jqgrid '/*JC*/+' jqgrow ui-row-'+a.p.direction+""+u+'">');if(a.p.rownumbers===true){H.push(F(0,e,a.p.page,a.p.rowNum));K=1}if(a.p.multiselect){H.push(t(B,K,e));O=1}if(a.p.subGrid){H.push(b(a).jqGrid("addSubGridCell",
...
'"':"";da+="<th id='"+a.p.id+"_"+a.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+na+">";na=a.p.colModel[k].index||a.p.colModel[k].name;da+="<div "/*JC*/+"style='font-weight: bold' id='jqgh_"+a.p.id+"_"+a.p.colModel[k].name+"' "+Ga+">"+a.p.colNames[k];a.p.colModel[k].width=a.p.colModel[k].width?parseInt(a.p.colModel[k].width,10):150;if(typeof a.p.colModel[k].title!=="boolean")a.p.colModel[k].title=true;if(na==a.p.sortname)a.p.lastsort=k;da+=oa+"</div></th>"}da+="</tr></thead>";oa=null;
...
return false});a(".fm-button","#info_dialog").hover(function(){a(this).addClass(""/*jc ui-state-hover"*/)},function(){a(this).removeClass("ui-state-hover")});a.isFunction(g.beforeOpen)&&g.beforeOpen();this.viewModal("#info_dialog",{onHide:function(i){i.w.hide().remove();i.o&&i.o.remove()},modal:g.modal,jqm:h});a.isFunction(g.afterOpen)&&g.afterOpen();try{a("#info_dialog").focus()}catch(q){}},createEl:function(b,c,d,f,g){function h(m,l){a.isFunction(l.dataInit)&&l.dataInit(m);l.dataEvents&&a.each(l.dataEvents,
...
"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");if(u){A=u(a("#"+o));if(typeof A=="undefined")A=true}if(A===false)return;j();a(c.p.colModel).each(function(){var g=this.formoptions;l=Math.max(l,g?g.colpos||0:0);y=Math.max(y,g?g.rowpos||0:0)});a(K).append(V);u=a("<tr id='FormError' style='display:none'><td "/*JC align*/+"align='center' class='ui-state-error "/*JC corner*/+"ui-corner-all' colspan='"+l*2+"'></td></tr>");u[0].rp=0;a(V).append(u);u=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+
l*2+"'>"+d[c.p.id].topinfo+"</td></tr>");u[0].rp=0;a(V).append(u);A=(u=c.p.direction=="rtl"?true:false)?"nData":"pData";var W=u?"pData":"nData";q(f,c,V,l);A="<a href='javascript:void(0)' id='"+A+"' class='fm-button button "/*jc2 ui-state-default"*/+" ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w' "/*JC*/+"style='margin:3px 0px 3px 4px'></span></a>";W="<a href='javascript:void(0)' id='"+W+"' class='fm-button button "/*jc2 ui-state-default"*/+" ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e' "/*JC*/+"style='margin:3px 0px 3px 4px'></span></a>";var $="<a href='javascript:void(0)' id='sData' class='button"/*JC*/+" fm-button "/*ui-state-default*/+" ui-corner-all'>"+
b.bSubmit+"</a>",Z="<a href='javascript:void(0)' id='cData' class='fm-button button"/*JC* ui-state-default*/+" ui-corner-all'>"+b.bCancel+"</a>";A="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+i+"_2'><tbody>"/*JC <tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr>*/+"<tr id='Act_Buttons'><td class='navButton'>"+(u?W+A:A+W)+"</td><td class='EditButton'>"+$+Z+"</td></tr>";A+="<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[c.p.id].bottominfo+
...
d[c.p.id].onClose);a.jgrid.viewModal("#"+m.themodal,{gbox:"#gbox_"+t,jqm:b.jqModal,overlay:b.overlay,modal:b.modal});Q||a(".jqmOverlay").click(function(){if(!n())return false;a.jgrid.hideModal("#"+m.themodal,{gb:"#gbox_"+t,jqm:b.jqModal,onClose:d[c.p.id].onClose});return false});J&&J(a("#"+o));a(".fm-button","#"+m.themodal).hover(function(){a(this).addClass(""/*"ui-state-hover"JC*/)},function(){a(this).removeClass("ui-state-hover")});a("#sData","#"+i+"_2").click(function(){h={};O={};a("#FormError","#"+i).hide();
...
viewPagerButtons:true},a.jgrid.view,b||{});return this.each(function(){function e(){if(b.closeOnEscape===true||b.navkeys[0]===true)setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+M.modalhead).focus()},0)}function q(l,y,h,O){for(var N,U,Q,K=0,V,W,$=[],Z=false,aa="<td class='CaptionTD form-view-label ui-widget-content_jqgrid"/*JC*/+"' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content_jqgrid"/*JC*/+"'>&#160;</td>",ba="",g=["integer","number","currency"],k=0,v=0,p,E,D,
...
d[e.p.id].msg+"</td></tr><tr><td >&#160;</td></tr>";i+="</tbody></table></div>";i+="<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"+j+"_2'><tbody>"/*JC <tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr>*/+"<tr><td class='DelButton EditButton'>"+("<a href='javascript:void(0)' id='dData' class='fm-button button "/*jc ui-state-default"*/+" ui-corner-all'>"+b.bSubmit+"</a>")+"&#160;"+("<a href='javascript:void(0)' id='eData' class='fm-button button "/*jc ui-state-default"*/+" ui-corner-all'>"+b.bCancel+
"</a>")+"</td></tr></tbody></table>";b.gbox="#gbox_"+B;a.jgrid.createModal(o,i,b,"#gview_"+e.p.id,a("#gview_"+e.p.id)[0]);if(G){n=G(a("#"+j));if(typeof n=="undefined")n=true}if(n===false)return;a(".fm-button","#"+j+"_2").hover(function(){a(this).addClass(""/*jc"ui-state-hover"*/)},function(){a(this).removeClass("ui-state-hover")});b.delicon=a.extend([true,"left","ui-icon-scissors"],d[e.p.id].delicon);b.cancelicon=a.extend([true,"left","ui-icon-cancel"],d[e.p.id].cancelicon);if(b.delicon[0]===true)a("#dData",
...
function(a){return o(this,a,"jqmShow")};b.fn.jqmShow=function(a){return this.each(function(){b.jqm.open(this._jqm,a)})};b.fn.jqmHide=function(a){return this.each(function(){b.jqm.close(this._jqm,a)})};b.jqm={hash:{},open:function(a,f){var c=j[a],d=c.c,i="."+d.closeClass,g=parseInt(c.w.css("z-index"));g=g>0?g:3E3;var h=b("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":g-1,opacity:d.overlay/60/*JC 100*/});if(c.a)return e;c.t=f;c.a=true;c.w.css("z-index",g);if(d.modal){k[0]||
...
":not("+c.p.sortable.exclude+")";b.sortable(f).data("sortable").floating=true})},columnChooser:function(b){function h(d,k){if(d)if(typeof d=="string")a.fn[d]&&a.fn[d].apply(k,a.makeArray(arguments).slice(2));else a.isFunction(d)&&d.apply(k,a.makeArray(arguments).slice(2))}var c=this;if(!a("#colchooser_"+c[0].p.id).length){var f=a('<div id="colchooser_'+c[0].p.id+'" style="'/*JC*/+'background:#fff;margin:5px 5px 0px 5px;'/*JC*/+'position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'),e=a("select",f);b=a.extend({width:500,
