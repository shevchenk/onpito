...
include_once("../../../Includes/config.php"); // 2 niveles porque esta ejecutandose desde el servlet.
include_once("../"._LIBRERIA_PHP_."pChart/class/pData.class.php");
include_once("../"._LIBRERIA_PHP_."pChart/class/pDraw.class.php");
include_once("../"._LIBRERIA_PHP_."pChart/class/pImage.class.php");
 
 // Create and populate the pData object //
$MyData = new pData(); 
$MyData->loadPalette("../"._LIBRERIA_PHP_."pChart/palettes/autumn.color",TRUE);
...
$myPicture->setFontProperties(array("FontName"=>"../"._LIBRERIA_PHP_."pChart/fonts/Silkscreen.ttf","FontSize"=>6));
$myPicture->drawText(10,13,"drawLabel() - Write labels over your charts",array("R"=>255,"G"=>255,"B"=>255));
 
// Write the chart title // 
$myPicture->setFontProperties(array("FontName"=>"../"._LIBRERIA_PHP_."pChart/fonts/Forgotte.ttf","FontSize"=>11));
...
$myPicture->setFontProperties(array("FontName"=>"../"._LIBRERIA_PHP_."pChart/fonts/pf_arma_five.ttf","FontSize"=>6));
...
$imagen="reporteGeneral_".$_GET['usuario'].".png";
echo "<IMG SRC='../reporte/IMG/IMGImagen/".$imagen."'>";
$myPicture->Render("IMGImagen/".$imagen);
