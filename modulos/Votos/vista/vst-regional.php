...
<html><head>
    ...
    <script src="../javascript/js/js-regional.js"></script>
...
<body>	
    ...
    <div class="bar_5 txt_temaM txt_11 sombratext1 brillohv">
      ...
      REGISTROS DE VOTOS&nbsp;<span class="icon_content icon_derblanc"></span>&nbsp; ACTA CAND. REGIONAL.</div>
          ...
          <div class="tabbable tabs-left">
            <ul class="nav nav-tabs" style="width:100%">
              <li class="active">
                ...
                <i class="icon-ok-sign"></i>ACTA CAND. REGIONAL.</a>
              </li>
            </ul>
        ...
        <div id="contenido" class="span12">          
          <div class="tab-content">            
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
                ...
                REGISTRO DE ACTAS DE CANDIDATO REGIONAL
              </div>
              <br>              
              <div class="span12">
