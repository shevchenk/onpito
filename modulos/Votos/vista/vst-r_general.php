...
<html><head>
    ...
    <script src="../javascript/js/js-r_general.js"></script>
        ...
        <div id="contenido" class="span12">          
          <div class="tab-content">            
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
              ...
              <br>
              <fieldset>
              <legend class="ui-widget-content_jqgrid ui-corner-all">REPORTE RANKING EN % DE VOTOS PROVINCIALES&nbsp;<i class="icon-list"></i></legend>
              <section>
                <br>
                <div class="span12">
                ...
                <div class="span12">
                  <label><b>RESULTADOS POR:</b></label>
                  <select id="slct_resultao" onChange="FiltrarResultado(this.value)">
                    <option value='0'>TODO LIMA</option>
                    <option value='1'>DISTRITO DE</option>
                  </select>
                </div>
                <div class="span12" id="label_distrito" style="display:none">
