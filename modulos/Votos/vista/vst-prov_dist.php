...
<html><head>
    ...
    <script src="../javascript/js/js-prov_dist.js"></script>
...
<body>	
    ...
    <div class="bar_5 txt_temaM txt_11 sombratext1 brillohv">
      ...
      REGISTROS DE VOTOS&nbsp;<span class="icon_content icon_derblanc"></span>&nbsp; ACTA CAND. PROV. Y DIST.</div>
          ...
          <div class="tabbable tabs-left">
            <ul class="nav nav-tabs" style="width:100%">
              <li class="active">
                ...
                <i class="icon-ok-sign"></i>ACTA CAND. PROV. Y DIST</a>
              </li>
            </ul>
        ...
        <div id="contenido" class="span12">          
          <div class="tab-content">            
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
                ...
                <b><font size="+1">REGISTRO DE ACTAS DE CANDIDATO PROVINCIAL Y DISTRITAL</font></b>
              </div>
              <br>              
              <div class="span12">
              ...
              <div class="span12">
                ...
                <label><b>N° VOTOS EMITIDOS PROV:</b></label>
                <input type="text" class="input-mediun input-sm" id="nrovotemitidos" disabled>
                <label><b>N° VOTOS EMITIDOS DIST:</b></label>
                <input type="text" class="input-mediun input-sm" id="nrovotemitidos2" disabled>
              </div>
