...
<html><head>
    ...
    <script src="../javascript/js/js-r_general_regional.js"></script>
        ...
        <div id="contenido" class="span12">          
          <div class="tab-content">            
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
              ...
              <br>
              <fieldset>
              <legend class="ui-widget-content_jqgrid ui-corner-all">REPORTE RANKING EN % DE VOTOS REGIONALES&nbsp;<i class="icon-list"></i></legend>
              <section>
