...
<html><head>
    ...
    <script src="../javascript/dao/dao-voto_masivo.js"></script>
    <script src="../javascript/js/js-voto_masivo_provincial.js"></script>
...
<body>	
    ...
    <div class="bar_5 txt_temaM txt_11 sombratext1 brillohv">
      ...
      CARGAR VOTOS&nbsp;<span class="icon_content icon_derblanc"></span>&nbsp;C. VOTO MASIVO</div>
          ...
          <div class="tabbable tabs-left">
            <ul class="nav nav-tabs" style="width:100%">
              <li class="active">
                ...
                <i class="icon-ok-sign"></i>CARGAR VOTO</a>
              </li>
            </ul>
            ...
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
              ...
              <section>
              	<article>
                    ...
                    <legend class="ui-widget-content_jqgrid ui-corner-all"><b>CARGAR VOTO MASIVO PROVINCIAL</b></legend>
                    <table id="table1">
                    <tr>
