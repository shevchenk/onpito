...
<html><head>
    ...
    <script src="../javascript/js/js-voto_masivo_distrital.js"></script>
            ...
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
              ...
              <section>
              	<article>
                    ...
                    <legend class="ui-widget-content_jqgrid ui-corner-all"><b>CARGAR VOTO MASIVO DISTRITAL</b></legend>
                    <table id="table1">
                    <tr>
