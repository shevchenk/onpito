...
<html><head>
    ...
    <script src="../javascript/js/js-provincial.js"></script>
...
<body>	
    ...
    <div class="bar_5 txt_temaM txt_11 sombratext1 brillohv">
      ...
      REGISTROS DE VOTOS&nbsp;<span class="icon_content icon_derblanc"></span>&nbsp; ACTA CAND. PROV.</div>
          ...
          <div class="tabbable tabs-left">
            <ul class="nav nav-tabs" style="width:100%">
              <li class="active">
                ...
                <i class="icon-ok-sign"></i>ACTA CAND. PROV.</a>
              </li>
            </ul>
        ...
        <div id="contenido" class="span12">          
          <div class="tab-content">            
            <div id="1A" class="tab-pane active"><!-- /////////////SEGUNDA OPCION//////////////////// -->
                ...
                <b><font size="+1">REGISTRO DE ACTAS DE CANDIDATO PROVINCIAL</font></b>
              </div>
              <br>              
              <div class="span12">
